...
Форма20040501 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151056", '20040414', "САЭ-3-23/286@", "ФормаОтчета2004Кв2");
ОпределитьФорматВДеревеФормИФорматов(Форма20040501, "3.00003");

Форма20070301 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151056", '20040414', "САЭ-3-23/286@", "ФормаОтчета2007Кв1");
ОпределитьФорматВДеревеФормИФорматов(Форма20070301, "3.00004");
...
НоваяФорма.ОписаниеОтчета     = "Утверждено приказом МНС России от 14.04.2004 г. № САЭ-3-23/286@";
НоваяФорма.ДатаНачалоДействия = '20040501';
НоваяФорма.ДатаКонецДействия  = '20070228';

НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2007Кв1";
НоваяФорма.ОписаниеОтчета     = "Утверждено приказом МНС России от 14.04.2004 г. № САЭ-3-23/286@, с возможностью выгрузки электронном виде в формате версии 3.00004";
