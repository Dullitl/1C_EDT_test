...
Форма20050101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151099", '20050303', "31н",	"ФормаОтчета2005кв1");
Форма20060101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151099", '20051228', "163н",	"ФормаОтчета2006Кв1");
Форма20070101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151099", '20061127', "153н",	"ФормаОтчета2007кв1");
Форма20090401 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151099", '20061127', "153н",	"ФормаОтчета2009кв2");
Форма20100401 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151099", '20091211', "б/н",	"ФормаОтчета2010кв2");
Форма20110501 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151099", '20091211', "б/н",	"ФормаОтчета2011кв2");
Форма20110701 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151099", '20091211', "б/н",	"ФормаОтчета2011кв3");

ОпределитьФорматВДеревеФормИФорматов(Форма20100401, "1.3.0", , , , '20101231');
ОпределитьФорматВДеревеФормИФорматов(Форма20100401, "5.01" , , , '20110101');
ОпределитьФорматВДеревеФормИФорматов(Форма20110501, "5.02" , , , '20110501');
ОпределитьФорматВДеревеФормИФорматов(Форма20110701, "5.03" , , , '20110701');
...
НоваяФорма.ДатаКонецДействия  = '20060131'; // До янв. 2006
...
НоваяФорма.ДатаКонецДействия  = '20090531';
...
НоваяФорма.ДатаНачалоДействия = '20090501';
...
НоваяФорма.ДатаКонецДействия  = '20120101'; // не использована пустая дата, чтобы предпочтение формы по умолчанию было отдано следующей форме
...
НоваяФорма.ДатаНачалоДействия = '20110501';
НоваяФорма.ДатаКонецДействия  = '20120102'; // не использована пустая дата, чтобы предпочтение формы по умолчанию было отдано следующей форме
