...
Процедура ВывестиДанныеПоБуквенно(Данные, Раздел, ИмяПоказателя, КоличествоЯчеек)

	Для НомЯчейки = 1 По КоличествоЯчеек Цикл
		Раздел.Области[ИмяПоказателя + Формат(НомЯчейки,"ЧГ=0")].Текст = Сред(Данные, НомЯчейки, 1);
	КонецЦикла;
...
Процедура ВывестиКарточку(ДокументРезультат, ДанныеФизЛиц, Уровень)
	...
	ВывестиДанныеПоБуквенно(ДанныеФизЛиц.Организация_ИНН, Раздел, "Организация_ИНН_", 12);
	ВывестиДанныеПоБуквенно(ДанныеФизЛиц.Организация_КПП, Раздел, "Организация_КПП_", 9);
	ВывестиДанныеПоБуквенно(СтрЗаменить(Формат(ДатаПодписи, "ДФ=dd.MM.yyyy"),".",""), Раздел, "Дата", 8);
	ВывестиДанныеПоБуквенно(Формат(ДанныеФизЛиц.Год, "ЧГ=0"), Раздел, "Год", 4);
	
	ВывестиДанныеПоБуквенно(ДанныеФизЛиц.Организация_Наименование, Раздел, "Организация_Наименование_", 160);
	...
	ВывестиДанныеПоБуквенно(Формат(ТекущийНомерСправки, "ЧГ=0"), Раздел, "Номер", 8);
	ВывестиДанныеПоБуквенно(ДанныеФизЛиц.Фамилия, Раздел, "ФизЛицо_Фамилия_", 33);
	ВывестиДанныеПоБуквенно(ДанныеФизЛиц.Имя, Раздел, "ФизЛицо_Имя_", 33);
	ВывестиДанныеПоБуквенно(ДанныеФизЛиц.Отчество, Раздел, "ФизЛицо_Отчество_", 33);
	ВывестиДанныеПоБуквенно(ДанныеФизЛиц.ФизЛицо_ИНН, Раздел, "ФизЛицо_ИНН_", 12);
	ВывестиДанныеПоБуквенно(ДанныеФизЛиц.ФизЛицо_КодДокументаУдЛичн, Раздел, "ФизЛицо_КодДокументаУдЛичн_", 2);
	ВывестиДанныеПоБуквенно(ДанныеФизЛиц.ФизЛицо_СерияНомерДокументаУдЛичн, Раздел, "ФизЛицо_СерияНомерДокументаУдЛичн_", 25);
	ВывестиДанныеПоБуквенно(ДанныеФизЛиц.ФизЛицо_АдресИндекс, Раздел, "ФизЛицо_АдресИндекс_", 6);
	ВывестиДанныеПоБуквенно(ПроцедурыУправленияПерсоналом.ПолучитьКодРегионаРФИзКодаАдресногоЭлемента(ДанныеФизЛиц.ФизЛицо_АдресРегион), Раздел, "ФизЛицо_АдресРегион_", 2);
	ВывестиДанныеПоБуквенно(ДанныеФизЛиц.ФизЛицо_АдресРайон, Раздел, "ФизЛицо_АдресРайон_", 33);
	ВывестиДанныеПоБуквенно(ДанныеФизЛиц.ФизЛицо_АдресГород, Раздел, "ФизЛицо_АдресГород_", 33);
	ВывестиДанныеПоБуквенно(ДанныеФизЛиц.ФизЛицо_АдресНаселенныйПункт, Раздел, "ФизЛицо_АдресНаселенныйПункт_", 33);
	ВывестиДанныеПоБуквенно(ДанныеФизЛиц.ФизЛицо_АдресУлица, Раздел, "ФизЛицо_АдресУлица_", 33);
	ВывестиДанныеПоБуквенно(ДанныеФизЛиц.ФизЛицо_АдресДом, Раздел, "ФизЛицо_АдресДом_", 8);
	ВывестиДанныеПоБуквенно(ДанныеФизЛиц.ФизЛицо_АдресКорпус, Раздел, "ФизЛицо_АдресКорпус_", 8);
	ВывестиДанныеПоБуквенно(ДанныеФизЛиц.ФизЛицо_АдресКвартира, Раздел, "ФизЛицо_АдресКвартира_", 8);
	ВывестиДанныеПоБуквенно(Прав("           " + Формат(ДанныеФизЛиц.ВзносыРаботника,"ЧЦ=11; ЧС=-2; ЧГ=0"),11), Раздел, "СуммаВзносовРубли_", 11);
