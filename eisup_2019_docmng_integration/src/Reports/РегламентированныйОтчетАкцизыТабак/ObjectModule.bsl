...
Форма20050301 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151074", '2005-03-03', "32н", "ФормаОтчета2005Кв1");
ОпределитьФорматВДеревеФормИФорматов(Форма20050301, "3.00000");

Форма20060101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151074", '2005-12-30', "168н", "ФормаОтчета2006Кв1");
ОпределитьФорматВДеревеФормИФорматов(Форма20060101, "3.00001");

Форма20070101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151074", '2006-11-14', "146н", "ФормаОтчета2007Кв1", , '20071231');
ОпределитьФорматВДеревеФормИФорматов(Форма20070101, "3.00002");

Форма20080101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151074", '2007-12-20', "142н", "ФормаОтчета2007Кв1", '20080101', );
...
НоваяФорма.ОписаниеОтчета     = "Форма утверждена приказом Минфина РФ от 03.03.2005г. № 32н (Приложение 7)";
НоваяФорма.ДатаНачалоДействия = '2005-03-01';
НоваяФорма.ДатаКонецДействия  = '2006-02-28';

НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2006Кв1";
НоваяФорма.ОписаниеОтчета     = "Форма утверждена приказом Минфина РФ от 03.03.2005г. № 32н (Приложение 7). В редакции приказа Минфина России от 30.12.2005 № 168н.";
