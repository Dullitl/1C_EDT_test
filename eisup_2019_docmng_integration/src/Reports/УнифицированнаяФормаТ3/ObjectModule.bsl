...
Функция СформироватьОтчет(Результат = Неопределено, ДанныеРасшифровки = Неопределено, ВыводВФормуОтчета = Истина) Экспорт
	...
	Для каждого ДанныеОрганизации из ДеревоДанных.Строки Цикл
		...
		Подписи.Параметры.ФИОКадровика = УправлениеОтчетами.ФамилияИнициалыОтветсвенногоЛица(ДанныеОрганизации.ФИОКадровика, ДанныеОрганизации.ФамилияКадровика, ДанныеОрганизации.ИмяКадровика, ДанныеОрганизации.ОтчествоКадровика);
		Подписи.Параметры.ФИОГлавбуха = УправлениеОтчетами.ФамилияИнициалыОтветсвенногоЛица(ДанныеОрганизации.ФИОГлавбуха, ДанныеОрганизации.ФамилияГлавбуха, ДанныеОрганизации.ИмяГлавбуха, ДанныеОрганизации.ОтчествоГлавбуха);
		...
		Для каждого ВыборкаСтрокШтРасписанияДолжность из ВыборкаСтрокШтРасписания.Строки Цикл 
			...
			Для каждого ВыборкаСтрокШтРасписанияНадбавка из ВыборкаСтрокШтРасписанияДолжность.Строки Цикл 
				...
				Если ВыборкаСтрокШтРасписанияНадбавка.РазмерНадбавки <> NULL и ВыборкаСтрокШтРасписанияНадбавка.РазмерНадбавки <> 0 Тогда
					...
					Если ВыборкаСтрокШтРасписанияНадбавка.ВходитВБазуРК тогда
