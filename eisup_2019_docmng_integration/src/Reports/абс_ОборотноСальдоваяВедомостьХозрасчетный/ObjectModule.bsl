...
Функция абс_СформироватьЗапрос(СтруктураПараметров) Экспорт
	...
	Для Каждого Показатель Из СтруктураПараметров.МассивПоказателей Цикл
		...
		КонецЦикла;
	        ...
	        |СГРУППИРОВАТЬ ПО
	        |	ОстаткиОбороты.Счет,
	        |	"+?(ПоВалютам,"ОстаткиОбороты.Валюта,","")+"
...
Функция СформироватьЗаголовок() Экспорт
	...
	КонецЕсли;
    ТекстСписокПоказателей = ТекстСписокПоказателей + " (с детализацией по ДЗО)";
...
Функция ЗаголовокОтчета() Экспорт
	Возврат "Оборотно-сальдовая ведомость (с детализацией по ДЗО)";
КонецФункции
