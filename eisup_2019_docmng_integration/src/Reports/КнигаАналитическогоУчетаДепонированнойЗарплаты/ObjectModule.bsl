...
УправлениеОтчетами.ПолучитьТаблицуРаботников(, ТекстЗапроса, "ТаблицаДвижения", истина);
УправлениеОтчетами.ПодставитьРасчетПолей(ТекстЗапроса, "РаботникиПредприятия", "РаботникиОрганизаций", "ПодразделениеОрганизации", "Должность");
