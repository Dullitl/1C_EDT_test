...
Форма20120101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1152016", '2012-01-23', "ММВ-7-3/13@", "ФормаОтчета2012Кв1");
ОпределитьФорматВДеревеФормИФорматов(Форма20120101, "5.03");

Форма20131231 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1152016", '2013-11-14', "ММВ-7-3/501@", "ФормаОтчета2013Кв4");
