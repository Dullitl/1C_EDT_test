...
ТекстЗапроса = "ВЫБРАТЬ
               ...
               |	ЗакупкиОбороты.ДокументЗакупки.абс_ЗакупочныйЗаказ КАК ЗакупочныйЗаказ,
               |	НАЧАЛОПЕРИОДА(ЗакупкиОбороты.ДокументЗакупки.абс_ДатаПоставки, МЕСЯЦ) КАК МесяцПоставки,
               |	ЗакупкиОбороты.Номенклатура,
               |	ЕСТЬNULL(ЗакупкиОбороты.СтоимостьОборот, 0) - ЕСТЬNULL(ЗакупкиОбороты.НДСОборот, 0) КАК Сумма
               ...
               |	МИНИМУМ(абс_ЗакупочныйЗаказГрафикПоставок.СуммаБезНДС) КАК СуммаБезНДС,
               |	ВТ_ЗЗ.Проект,
               |	ВТ_ЗЗ.ЗакупочныйЗаказ
               |ПОМЕСТИТЬ ВТ_ГрафикПоставок
               |ИЗ
               |	ВТ_ЗЗ КАК ВТ_ЗЗ
               |		ВНУТРЕННЕЕ СОЕДИНЕНИЕ Документ.абс_ЗакупочныйЗаказ.ГрафикПоставок КАК абс_ЗакупочныйЗаказГрафикПоставок
               |		ПО ВТ_ЗЗ.ЗакупочныйЗаказ = абс_ЗакупочныйЗаказГрафикПоставок.Ссылка
               |ГДЕ
               |	абс_ЗакупочныйЗаказГрафикПоставок.Период МЕЖДУ &ДатаНачала И &ДатаКонца
               |
               |СГРУППИРОВАТЬ ПО
               |	ВТ_ЗЗ.ЗакупочныйЗаказ,
               |	ВТ_ЗЗ.Проект,
               |	НАЧАЛОПЕРИОДА(абс_ЗакупочныйЗаказГрафикПоставок.Период, МЕСЯЦ)
               |;
               |
               |////////////////////////////////////////////////////////////////////////////////
               |ВЫБРАТЬ
               |	ВТ_ГрафикПоставок.Проект,
               |	ВТ_ГрафикПоставок.ЗакупочныйЗаказ,
               |	ВТ_Поставки.ДокументЗакупки,
               |	ВТ_ГрафикПоставок.СуммаБезНДС КАК СуммаЗЗ,
               |	ВТ_Поставки.Номенклатура,
               |	ВТ_Поставки.Сумма КАК Сумма,
               |	ВТ_ГрафикПоставок.Период
               |{ВЫБРАТЬ
               |	Проект.*,
               |	ЗакупочныйЗаказ.*,
               |	ДокументЗакупки.*,
               ...
               |		ЛЕВОЕ СОЕДИНЕНИЕ ВТ_Поставки КАК ВТ_Поставки
               |		ПО ВТ_ГрафикПоставок.ЗакупочныйЗаказ = ВТ_Поставки.ЗакупочныйЗаказ
               |			И ВТ_ГрафикПоставок.Период = ВТ_Поставки.МесяцПоставки
               |ГДЕ
               |	ВТ_ГрафикПоставок.СуммаБезНДС <> 0
               |{ГДЕ
               |	ВТ_ГрафикПоставок.Проект.*,
               |	ВТ_ГрафикПоставок.ЗакупочныйЗаказ.*,
               |	ВТ_ГрафикПоставок.Период}
	...
	//УниверсальныйОтчет.ИмяРегистра = "абс_ПоступлениеДДСПоПроектам";
	...
	УниверсальныйОтчет.ДобавитьПоказатель("СуммаЗЗ", "Сумма в графике", Ложь, "ЧЦ=15; ЧДЦ=2", "СуммаЗЗ", "Сумма в графике");
	УниверсальныйОтчет.ДобавитьПоказатель("Сумма", "Сумма в поступлении", Ложь, "ЧЦ=15; ЧДЦ=2", "СуммаЗЗ", "Сумма в поступлении");
