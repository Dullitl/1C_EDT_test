...
Процедура ДоработатьКомпоновщикПередВыводом() Экспорт
	УправлениеОтчетамиПереопределяемый.ОценкиКомпетенцийРаботниковДоработкаКомпоновщика(ЭтотОбъект);	
КонецПроцедуры
...
УправлениеОтчетамиПереопределяемый.ОценкиКомпетенцийРаботниковПриСозданииОтчета(ЭтотОбъект);
