...
Форма20110401 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151054", '2011-04-07', "MMB-7-3/253@", "ФормаОтчета2011Кв2");
ОпределитьФорматВДеревеФормИФорматов(Форма20110401, "5.01");

Форма20120101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151054", '2011-12-16', "ММВ-7-3/928@", "ФормаОтчета2012Кв1");
ОпределитьФорматВДеревеФормИФорматов(Форма20120101, "5.02");

Форма2013Кв4 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1151054", '2013-11-14', "ММВ-7-3/501@", "ФормаОтчета2013Кв4");
