...
Процедура СформироватьМакет(ДокументРезультат, Работник, ЕстьОшибки, Уровень) Экспорт
	...
	Пока Образование.НайтиСледующий(СтруктураПоискаФизЛицо) Цикл
		Т4.Параметры["ВысшееОбразование"]     = Образование.УчебноеЗаведение + ", " + Образование.ГодОкончания;
	КонецЦикла;
	...
	Т4.Параметры["ФИОКадровика"]       = УправлениеОтчетами.ФамилияИнициалыОтветсвенногоЛица(КадровыйРаботник.ФизЛицо);
