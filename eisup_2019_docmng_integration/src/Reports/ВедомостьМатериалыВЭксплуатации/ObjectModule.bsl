...
Процедура УстановитьНачальныеНастройки(ДополнительныеПараметры = Неопределено) Экспорт
	...
	ТекстЗапроса = 
		...
		|	РегМатериалы.МестоЭксплуатацииПоСооружению,
		|	ПРЕДСТАВЛЕНИЕ(РегМатериалы.МестоЭксплуатацииПоСооружению) КАК МестоЭксплуатацииПоСооружениюПредставление,
		...
		|		 ФизЛицо.*                    КАК ФизЛицо, (МестоЭксплуатацииПоСооружению).* КАК МестоЭксплуатацииПоСооружению}) КАК РегМатериалы
		|	//СОЕДИНЕНИЯ
		|{ГДЕ
		|	РегМатериалы.КоличествоНачальныйОстаток КАК КолНачОст,
		|	РегМатериалы.КоличествоКонечныйОстаток КАК КолКонОст,
	...
	УниверсальныйОтчет.мСтруктураПредставлениеПолей.Вставить( "МестоЭксплуатацииПоСооружению", "Место эксплуатации по сооружению");
	...
	УниверсальныйОтчет.ДобавитьОтбор("МестоЭксплуатацииПоСооружению");
