...
Процедура ДоработатьКомпоновщикПередВыводом() Экспорт
	...
	ЗначениеПараметра = КомпоновщикНастроек.Настройки.ПараметрыДанных.НайтиЗначениеПараметра(Новый ПараметрКомпоновкиДанных("СписокПустыхЗначений"));
	ЗначениеПараметра.Значение = СписокПустыхЗначений;
КонецПроцедуры                                        
