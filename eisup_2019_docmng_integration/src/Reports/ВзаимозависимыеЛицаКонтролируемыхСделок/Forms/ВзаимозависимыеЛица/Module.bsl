...
Процедура УстановитьПараметрУведомление(Отчет)
	...
	Для Каждого Элемент Из ПользовательскиеНастройки.Элементы Цикл
		...
		ИначеЕсли ТипЗнч(Элемент) = Тип("ЗначениеПараметраНастроекКомпоновкиДанных")
			И Элемент.Параметр = Новый ПараметрКомпоновкиДанных("Организация") Тогда
			Элемент.Значение = Отчет.Организация;
		КонецЕсли;
	КонецЦикла;
КонецПроцедуры
...
Процедура ПриЗагрузкеВариантаНаСервере(Настройки)
	...
	Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.Элементы.Найти("НачалоПериода").Значение 	= НачалоГода(Отчет.Уведомление.Дата);
	Отчет.КомпоновщикНастроек.Настройки.ПараметрыДанных.Элементы.Найти("ОкончаниеПериода").Значение = КонецГода(Отчет.Уведомление.Дата);
...
Процедура РезультатОбработкаРасшифровки(Элемент, Расшифровка, СтандартнаяОбработка)
	...
	Если НЕ ЗначенияПолейРасшифровки.Свойство("ТипВзаимозависимости") Тогда
