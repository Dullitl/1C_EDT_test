...
Функция ПолучитьПараметрыИсполненияОтчета() Экспорт
    ...
    СписокНастроек = УправлениеОтчетамиПереопределяемый.ДоступныеНастройкиДляСостоянияКадровогоПлана();
	...
	ложь, ложь, ложь, ложь, ложь, ложь, ложь, ложь, ложь, истина, СписокПолейПодстановкиОтборовПоУмолчанию, СписокНастроек);
...
УправлениеОтчетамиПереопределяемый.УстановитьСКДОтчетСостояниеКадровогоПлана(ЭтотОбъект);
