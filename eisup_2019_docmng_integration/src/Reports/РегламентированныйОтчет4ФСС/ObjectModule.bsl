...
Форма20040101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1159999", '20031201', "130",	"ФормаОтчета2004Кв1");

Форма20050101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1159999", '20041222', "111",	"ФормаОтчета2005Кв1");

Форма20060401 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1159999", '20060331', "37",	"ФормаОтчета2006Кв2");

Форма20070101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1159999", '20070119', "11",	"ФормаОтчета2007Кв1");

Форма20070701 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1159999", '20070821', "192",	"ФормаОтчета2007Кв3");

Форма20090401 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1159999", '20090413', "92",	"ФормаОтчета2009Кв2");

Форма20100101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1159999", '20091106', "871н",	"ФормаОтчета2010Кв1");
ОпределитьФорматВДеревеФормИФорматов(Форма20100101, "0.1");

Форма20101201 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1159999", '20101221', "1147н",	"ФормаОтчета2010Кв4");
ОпределитьФорматВДеревеФормИФорматов(Форма20101201, "0.1");

Форма20110101 = ОпределитьФормуВДеревеФормИФорматов(мФормыИФорматы, "1159999", '20110228', "156н",	"ФормаОтчета2011Кв1");
...
НоваяФорма.ДатаКонецДействия  = '20090331';
...
НоваяФорма.ОписаниеОтчета     = "Приложение N1 к Приказу Минздравсоцразвития России от 28.02.2011 № 156н";
