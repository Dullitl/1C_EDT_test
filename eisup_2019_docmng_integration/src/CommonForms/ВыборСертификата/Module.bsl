...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("ЗагрузкаСертификата") И Параметры.ЗагрузкаСертификата Тогда
		ЭтаФорма.Заголовок = "Выбор персонального сертификата для загрузки";
		Элементы.ФормаВыбрать.Заголовок = "Выбрать";
	КонецЕсли;
