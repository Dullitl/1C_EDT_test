...
Процедура Сохранить(Команда)
	...
	Иначе
		ПараметрыПечати = Новый Структура("Уведомление", Документ);
		ПараметрыПечати.Вставить("СохранитьВФайл",Истина);
		ПараметрыПечати.Вставить("ПутьВКаталог",?(Переключатель = 2,ПутьДляВыгрузки,Дискета));
