...
Процедура ПодготовитьДанныеАвтоматическогоЗаполненияНаСервере()
	...
	Документы.УведомлениеОКонтролируемыхСделках.ПодготовитьДанныеАвтоматическогоЗаполнения(Объект.Ссылка,СписокФилиалов);
	УстановитьСведенияОСделке();
...
Процедура ЗаполнитьУведомлениеНаСервере()
	 СписокФилиалов = Новый СписокЗначений;
	 СписокФилиалов.Добавить(Объект.Организация);
	Документы.УведомлениеОКонтролируемыхСделках.СформироватьКонтролируемыеСделкиУведомления(Объект.Ссылка,СписокФилиалов);
	УстановитьСведенияОСделке();
