...
Функция ПечатьБухгалтерскойСправки()
	...
	|ИЗ
	|	Документ.абс_ОперацияЗаб КАК ОперацияБух
	|ГДЕ
	...
	|ИЗ
	|	РегистрБухгалтерии.ЗабалансовыйУчет.ДвиженияССубконто(, , Регистратор = &Регистратор) КАК ХозрасчетныйДвиженияССубконто
	|
	|УПОРЯДОЧИТЬ ПО
	|	НомерСтроки";
...
Процедура ПриКопировании(ОбъектКопирования)
	...
	Если ТипЗнч(ОбъектКопирования) <> Тип("ДокументОбъект.абс_ОперацияЗаб") Тогда
		Возврат;
	КонецЕсли;
...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	Иначе
		...
		|	0 
		|ИЗ
		|	Документ.абс_ОперацияЗаб КАК Операция
		|
		|ГДЕ
