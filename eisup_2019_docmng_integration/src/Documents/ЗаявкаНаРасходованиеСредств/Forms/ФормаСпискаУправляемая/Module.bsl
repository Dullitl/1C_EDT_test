...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//// АБС ВСТАВКА Сделал АБС-Ф чтобы работало
	//Список.Параметры.УстановитьЗначениеПараметра("СостояниеУтвержден", Перечисления.СостоянияОбъектов.Подготовлен);
	//Список.Параметры.УстановитьЗначениеПараметра("СостояниеУтвержден", Перечисления.СостоянияОбъектов.Отклонен);
	//Список.Параметры.УстановитьЗначениеПараметра("СостояниеУтвержден", Перечисления.СостоянияОбъектов.Отложен);
	//// АБС ВСТАВКА Сделал АБС-Ф чтобы работало КОНЕЦ
	//
