...
Процедура ПереносТранзакций(Отказ, Заголовок)
	...
	ОбщегоНазначенияКлиентСервер.ДополнитьТаблицу(ТабОборотовДокумента,ТабОборотыБюджетов);
	...
	ОбщегоНазначенияКлиентСервер.ДополнитьТаблицу(ТабПроводокДокумента,ТабБюджетирование);
