...
Функция ПолучитьПараметрыПечатиСчетаЗаказа(Тип, ДокументСсылка) Экспорт	
	...
	Для каждого ВыборкаСтрокТовары Из ЗапросТовары Цикл 
		...
		//АБС ИЗМЕНЕНИЕ 22103  01.11.2013 15:30:49  Коломиец
...
// Необходимо для работы обработки групповой печати пакета документов и отправки по электронной почте
