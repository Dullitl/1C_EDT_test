...
Функция ПечатьИНВ18() Экспорт
	...
	Запрос.Текст = 
	"ВЫБРАТЬ
	|	абс_ИнвентаризацияЗабалансОС.Дата КАК Дата,
	|	абс_ИнвентаризацияЗабалансОС.Номер КАК Номер,
	|	абс_ИнвентаризацияЗабалансОС.Организация КАК Организация,
	|	абс_ИнвентаризацияЗабалансОС.ПодразделениеОрганизации.Представление КАК ПодразделениеПредставление,
	|	абс_ИнвентаризацияЗабалансОС.ПодразделениеОрганизации.Код КАК ПодразделениеКод,
	|	абс_ИнвентаризацияЗабалансОС.ДатаНачалаИнвентаризации КАК ДатаНачалаИнвентаризации,
	|	абс_ИнвентаризацияЗабалансОС.ДатаОкончанияИнвентаризации КАК ДатаОкончанияИнвентаризации,
	|	абс_ИнвентаризацияЗабалансОС.ДокументОснованиеВид КАК ДокументОснованиеВид,
	|	абс_ИнвентаризацияЗабалансОС.ДокументОснованиеДата КАК ДокументОснованиеДата,
	|	абс_ИнвентаризацияЗабалансОС.ДокументОснованиеНомер КАК ДокументОснованиеНомер
	|ИЗ
	|	Документ.абс_ИнвентаризацияЗабалансОС КАК абс_ИнвентаризацияЗабалансОС
	|ГДЕ
	|	абс_ИнвентаризацияЗабалансОС.Ссылка = &Ссылка";
	...
	Запрос.Текст = 
	"ВЫБРАТЬ РАЗРЕШЕННЫЕ
	|	абс_ИнвентаризацияЗабалансОСОС.НомерСтроки КАК НомерСтроки,
	|	абс_ИнвентаризацияЗабалансОСОС.ОсновноеСредство КАК ОсновноеСредство,
	|	абс_ИнвентаризацияЗабалансОСОС.ОсновноеСредство.Наименование КАК ОсновноеСредствоНаименованиеПолное,
	|	"""" КАК ДатаВыпуска,
	|	"""" КАК ЗаводскойНомер,
	|	абс_ИнвентаризацияЗабалансОСОС.ОсновноеСредство.ИнвНомерАрендодателя КАК ИнвентарныйНомер,
	|	"""" КАК НомерПаспорта,
	|	абс_ИнвентаризацияЗабалансОСОС.СтоимостьПоДаннымУчета КАК СтоимостьПоДаннымУчета,
	|	абс_ИнвентаризацияЗабалансОСОС.СтоимостьФактическая КАК СтоимостьФактическая,
	|	абс_ИнвентаризацияЗабалансОСОС.НаличиеПоДаннымУчета КАК НаличиеПоДаннымУчета,
	|	абс_ИнвентаризацияЗабалансОСОС.НаличиеФактическое КАК НаличиеФактическое,
	|	абс_ИнвентаризацияЗабалансОСОС.МОЛ КАК МОЛ,
	|	абс_ИнвентаризацияЗабалансОСОС.Контрагент КАК Арендодатель
	|ИЗ
	|	Документ.абс_ИнвентаризацияЗабалансОС.ОС КАК абс_ИнвентаризацияЗабалансОСОС
	|ГДЕ
	|	абс_ИнвентаризацияЗабалансОСОС.Ссылка = &Ссылка
	|
	|УПОРЯДОЧИТЬ ПО
	|	НомерСтроки";
	...
	ТабДокумент.ИмяПараметровПечати = "ПАРАМЕТРЫ_ПЕЧАТИ_абс_ИнвентаризацияЗабалансОС_ИНВ18";
	...
	Шапка.Параметры.Организация          = ФормированиеПечатныхФормСервер.ОписаниеОрганизации(СведенияОбОрганизации);
	...
	СписокМОЛ = ТаблицаОС.ВыгрузитьКолонку("МОЛ");
	...
	Для Каждого СтрокаОС Из ТаблицаОС Цикл
		...
		ПредставлениеАрендодетеля = ФормированиеПечатныхФормСервер.ОписаниеОрганизации(УправлениеКонтактнойИнформацией.СведенияОЮрФизЛице(СтрокаОС.Арендодатель, Дата), "ПолноеНаименование,");
		СтрокаТаблицы.Параметры.Арендодатель = ПредставлениеАрендодетеля;			
...
Функция ПечатьИНВ22() Экспорт
	...
	|	абс_ИнвентаризацияЗабалансОС.ДокументОснованиеДата КАК ДокументОснованиеДата,
	|	абс_ИнвентаризацияЗабалансОС.ДокументОснованиеНомер КАК ДокументОснованиеНомер,
	|	абс_ИнвентаризацияЗабалансОС.ПричинаПроведенияИнвентаризации КАК ПричинаПроведенияИнвентаризации,
	|	абс_ИнвентаризацияЗабалансОС.ИнвентаризационнаяКомиссия.(
	|		ФизЛицо КАК ФизЛицо,
	...
	|
	|УПОРЯДОЧИТЬ ПО
	|	абс_ИнвентаризацияЗабалансОС.ИнвентаризационнаяКомиссия.НомерСтроки";
	...
	// Загрузим настройки пользователя
	ТабДокумент.ИмяПараметровПечати = "ПАРАМЕТРЫ_ПЕЧАТИ_абс_ИнвентаризацияЗабалансОС_ИНВ22";
