...
//	|ГДЕ
//	|	КорректировочныйСчетФактураПолученный.ДокументыОснования.Абс_Основание = &ДокументСсылка";
//	
...
//			ОбъектСчетаФактуры = Документы.КорректировочныйСчетФактураПолученный.СоздатьДокумент();
//			
