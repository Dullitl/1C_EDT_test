...
Процедура ДвиженияПоРегистрам(СтруктураШапкиДокумента, ТаблицаПоДокументамНоменклатура, ТаблицаПоДокументамЦеновыеГруппы, ТаблицаПоДокументамБонусы, Отказ, Заголовок)
	...
	ОбщегоНазначенияКлиентСервер.ДополнитьТаблицу(ТаблицаПоДокументамНоменклатура, ТаблицаДвижений);
	...
	ОбщегоНазначенияКлиентСервер.ДополнитьТаблицу(ТаблицаПоДокументамЦеновыеГруппы, ТаблицаДвижений);
	...
	ОбщегоНазначенияКлиентСервер.ДополнитьТаблицу(ТаблицаПоДокументамБонусы, ТаблицаДвижений);
...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Если ТаблицаПоДокументамНоменклатура.Количество() = 0
	   ...
	   ttk_ОбщегоНазначения.СообщитьОбОшибке("Не найдены движения по документам, указанным для отмены", Отказ, Заголовок);
	КонецЕсли;
