...
Процедура УстановитьВидимость()
	...
	мУчетнаяПолитика = ttk_ОбщегоНазначения.ПолучитьПараметрыУчетнойПолитикиУпр(?(ЗначениеЗаполнено(Объект.Ссылка), Объект.Дата,ТекущаяДата()));
...
Процедура СчетУчетаДоходовПоТареБУПриИзменении(Элемент)
	Объект.СчетУчетаДоходовПоТареНУ = БухгалтерскийУчет.ПреобразоватьСчетаБУвСчетНУ(Новый Структура("СчетБУ", Объект.СчетУчетаДоходовПоТареБУ));
КонецПроцедуры

&НаКлиенте
Процедура СчетУчетаРасходовПоТареБУПриИзменении(Элемент)
	Объект.СчетУчетаРасходовПоТареНУ = БухгалтерскийУчет.ПреобразоватьСчетаБУвСчетНУ(Новый Структура("СчетБУ", Объект.СчетУчетаРасходовПоТареБУ));
КонецПроцедуры
...
Процедура ТоварыПереданныеСобственныеБУПриИзменении(Элемент)
	...
	СтрокаТабличнойЧасти.ПереданныеСобственныеНУ = БухгалтерскийУчет.ПреобразоватьСчетаБУвСчетНУ(Новый Структура("СчетБУ", СтрокаТабличнойЧасти.ПереданныеСобственныеБУ));
КонецПроцедуры
...
Процедура ТоварыПереданныеПринятыеБУПриИзменении(Элемент)
	...
	СтрокаТабличнойЧасти.ПереданныеПринятыеНУ = БухгалтерскийУчет.ПреобразоватьСчетаБУвСчетНУ(Новый Структура("СчетБУ", СтрокаТабличнойЧасти.ПереданныеПринятыеБУ));
КонецПроцедуры
...
&НаКлиенте
Процедура ТоварыСубконтоБУНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	СтрокаТабличнойЧасти = Элементы.Товары.ТекущиеДанные;
...
&НаКлиенте
Процедура ТоварыСубконтоНУНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	СтрокаТабличнойЧасти = Элементы.Товары.ТекущиеДанные;
