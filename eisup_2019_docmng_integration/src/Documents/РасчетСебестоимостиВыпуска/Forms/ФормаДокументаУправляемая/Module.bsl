...
Процедура ЗаполнитьВыполняемыеДействия()
	...
	МассивДействий = ПроцедурыРасчетаСебестоимостиВыпуска.ПолучитьМассивВыполняемыхДействий(Объект.ПериодРегистрации, Объект.Организация, Объект.ОтражатьВУправленческомУчете, Объект.ОтражатьВНалоговомУчете, Истина);
