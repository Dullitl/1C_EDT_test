...
Процедура Автозаполнение(Организация, Период, Сообщать = Ложь) Экспорт 
	...
	Если НЕ ЗначениеЗаполнено(Организация) Тогда
		Если Сообщать Тогда
			ttk_ОбщегоНазначения.СообщитьОбОшибке(ОбщегоНазначения.ПреобразоватьСтрокуИнтерфейса("Не указана организация!"));
		КонецЕсли;
		Возврат;
	КонецЕсли;
	...
	Если НЕ ЗначениеЗаполнено(Период) Тогда
		Если Сообщать Тогда
			ttk_ОбщегоНазначения.СообщитьОбОшибке("Не указана дата!");
		КонецЕсли;
		Возврат;
	КонецЕсли;
...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	Для Каждого Запись Из ЭтотОбъект Цикл
		...
		Если Не ЗначениеЗаполнено(Запись.Период) Тогда
			...
			#Иначе
				ttk_ОбщегоНазначения.СообщитьОбОшибке(СрокаСообщенияОбОшибке, Отказ, "Элемент не записан!", СтатусСообщения.Важное);
			#КонецЕсли
		КонецЕсли;
