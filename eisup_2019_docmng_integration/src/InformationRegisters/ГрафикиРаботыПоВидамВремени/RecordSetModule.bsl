...
Процедура ПередЗаписью(Отказ, Замещение)
	...
	Если (Отбор.План.Значение = Ложь) И (Отбор.План.Использование)
		...
		ЗапросРасчетаОсновногоЗначения.УстановитьПараметр("Сотрудник", Отбор.ГрафикРаботы.Значение);
		Сотрудник = Отбор.ГрафикРаботы.Значение;
		
		ИмяТаблицы = "РаботникиОрганизаций";
		...
		|ГДЕ
		|	Графики.ГрафикРаботы = &Сотрудник
		...
		Если ЗапросРасчетаОсновногоЗначения.Выполнить().Выбрать().Количество() = 1 Тогда
			...
			|	РасчетОсновногоЗначения.ОсновноеЗначение КАК ОсновноеЗначениеНормаПолное,
			|	РасчетОсновногоЗначения.ДополнительноеЗначение КАК ДополнительноеЗначениеНормаПолное,
			...
			|	РасчетОсновногоЗначения.ОсновноеЗначение - РасчетОсновногоЗначения.ОсновноеЗначениеНорма КАК ОсновноеЗначениеНорма,
			|	РасчетОсновногоЗначения.ДополнительноеЗначение - РасчетОсновногоЗначения.ДополнительноеЗначениеНорма КАК ДополнительноеЗначениеНорма,
			|	ЗаписьНабора.Документ,
			|	ЗаписьНабора.ОсновноеЗначениеПолное,
			|	ЗаписьНабора.ДополнительноеЗначениеПолное,
			|	ЗаписьНабора.Месяц,
