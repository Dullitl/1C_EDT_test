...
Процедура ПодготовитьФормуНаСервере()
	...
	ЮрЛицо = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Запись.Контрагент, "ЮрФизЛицо") = Перечисления.ЮрФизЛицо.ЮрЛицо;
	...
	ЭтаФорма.Элементы.Контрагент.Доступность				= ДоступностьКлючевыхЗаписей;
...
Процедура КонтрагентПриИзменении(Элемент)
	...
	ЮрЛицо = ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Запись.Контрагент, "ЮрФизЛицо") = ПредопределенноеЗначение("Перечисление.ЮрФизЛицо.ЮрЛицо");
	УправлениеФормой(ЭтаФорма);
