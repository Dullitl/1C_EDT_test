...
Функция ПолучитьЗначениеКлючаАналитики(
	...
	Иначе
		...
		ttk_ОбщегоНазначения.СообщитьОбОшибке("Указан неправильный ключ аналитики!
			|Функция <ПолучитьЗначениеКлючаАналитики>");
	КонецЕсли;
...
Процедура ДвижениеПоРегиструУчетЗатратПоВидуУчета(
	...
	Иначе
		ttk_ОбщегоНазначения.СообщитьОбОшибке("Не определено формирование движений по виду отражения в учете: """ + ВидОтраженияВУчете + """.
			|Процедура <ДвижениеПоРегиструУчетЗатратПоВидуУчета>");
		Возврат;
	КонецЕсли;
