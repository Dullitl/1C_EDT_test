...
Функция ПолучитьСостояниеДокументов(Ссылки) Экспорт
	...
	Возврат ЗарплатаКВыплатеОрганизацийСервис.ПолучитьСостояние(Ссылки);
...
Функция СписокВидовДокументов() Экспорт
	...
	РаботаСДиалогами.ДополнитьСписокВидовДокументов(Метаданные.ЖурналыДокументов.ДокументыПоВыплатеЗарплатыОрганизаций, СписокВидовДокументов);	
