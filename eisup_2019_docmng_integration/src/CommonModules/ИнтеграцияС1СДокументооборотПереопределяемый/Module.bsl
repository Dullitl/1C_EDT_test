...
// 
//  Пример реализации:
//	Если ТипСвойства = "DMDocumentStatus"
//		И ИмяСвойства = "СостояниеСогласование" Тогда
...
// предъявляемый пользователю, теми объектами, которые не могут быть определены автоматически по ссылкам из шапки или из
