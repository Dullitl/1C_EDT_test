...
Функция НайтиИлиСоздатьКлассификаторЕдиницИзмеренияПоМеждународномуСокращению(Знач МеждународноеСокращение) Экспорт
	...
	Если НЕ ЗначениеЗаполнено(ЕдиницаПоКлассификатору) Тогда
		ttk_ОбщегоНазначения.СообщитьОбОшибке("Не найден классификатор единиц измерения с международным сокращением: " + МеждународноеСокращение);
...
//
Процедура ЗапускИнтерфейсаКассира(ТекущийПользователь, ВключенИнтерфейсКассира) Экспорт
