...
// АБС ВСТАВКА АБС-Ф 20111206
// Для контроля бюджета под полными правами
Функция ПолучитьЗначениеПраваПользователяБезУчетаПолныхПрав(Право, ЗначениеПоУмолчанию) Экспорт
...
КонецФункции
// АБС ВСТАВКА АБС-Ф 20111206 КОНЕЦ
...
Функция РазрешеноПревышениеКонтролируемыхЗначенийПоБюджетам() Экспорт
	...
	// АБС ВСТАВКА АБС-Ф 20111206
	// Для контроля бюджета под полными правами
	МассивЗначенийПрава = ПолучитьЗначениеПраваПользователяБезУчетаПолныхПрав(ПланыВидовХарактеристик.ПраваПользователей.РазрешитьПревышениеКонтролируемыхЗначенийПоБюджетам, Ложь);
