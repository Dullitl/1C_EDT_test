...
Функция МассивПредопределенныхНеРегистрируемыхОбъектов() Экспорт
	...
	Результат.Добавить("РегистрСведений.внНеРегистрируемыеОбъекты");
...
Функция ВеренПараметрУникальности() Экспорт
	...
	Иначе
		...
		Иначе
			МассивСерверов		= внЖурналРегистрации.внРазложитьСтрокуВМассивПодстрок(ПУСписокСерверов, ";", Истина);
...
Функция НеРегистрируемыеОбъектыМетаданных(ПолноеИмя) Экспорт
	...
	Возврат внЖурналРегистрацииСервер.НеРегистрируемыеОбъектыМетаданных(ПолноеИмя);
