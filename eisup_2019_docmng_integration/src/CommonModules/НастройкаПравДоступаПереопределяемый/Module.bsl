...
Функция ДоступнаРольРасчетчикаРегл() Экспорт
	...
	//Крамаренко Д.М.
	//Правильный код
	//Если Метаданные.Роли.Найти("УдалитьРасчетчикРегламентированнойЗарплатыБезОграниченияПрав") = Неопределено Тогда
	//	Возврат Ложь;
	//Иначе Возврат РольДоступна("УдалитьРасчетчикРегламентированнойЗарплатыБезОграниченияПрав");
	//КонецЕсли;
...
Функция ДоступнаРольКадровикаРегл() Экспорт
	...
	//Крамаренко Д.М.
	//Правильный код
	//Если Метаданные.Роли.Найти("УдалитьКадровикРегламентированныхДанныхБезОграниченияПрав") = Неопределено Тогда
	//	Возврат Ложь;
	//Иначе Возврат РольДоступна("УдалитьКадровикРегламентированныхДанныхБезОграниченияПрав");
	//КонецЕсли;	
...
Функция ДоступнаРольМенеджераПоНабору() Экспорт
	...
	//Крамаренко Д.М.
	//Правильный код
	//Если Метаданные.Роли.Найти("УдалитьМенеджерПоНаборуПерсоналаБезОграниченияПрав") = Неопределено Тогда
	//	Возврат Ложь;
	//Иначе Возврат РольДоступна("УдалитьМенеджерПоНаборуПерсоналаБезОграниченияПрав");
	//КонецЕсли;
...
Процедура ДополнитьСоставСтраницФормыОбработки(ЭтаФорма, НазначаемыеДействия) Экспорт
	...
	НадписьИнфо.Заголовок = "Подразделения компании, по которым пользователю доступна информация о вакансиях и заявках кандидатов.";
