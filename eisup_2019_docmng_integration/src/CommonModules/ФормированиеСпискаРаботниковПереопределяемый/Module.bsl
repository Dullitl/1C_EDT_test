...
//   Текст запроса
//
Функция ПолучитьТекстЗапросаНачальныеНастройкиДругиеРегистры(ОбработкаОбъект, СтруктураПредставлениеПолей, СтруктураФорматаПолей, СоответствиеНазначений, СтруктураДляОтбораПоКатегориям, ТаблицаПолей, СтрокаТаблицаПолей) Экспорт
