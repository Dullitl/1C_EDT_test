...
//   Текст – текст запроса по нематериальным производственным расходам.
//
Функция СформироватьТекстЗапросаНематериальныеПроизводственныеРасходыНУ()
...
Процедура ВывестиСообщенияОбОшибкахРаспределенияПоПеределам(
	...
	Если ТаблицаОшибок.Количество() > 0 Тогда
		...
		ttk_ОбщегоНазначения.СообщитьОбОшибке("Не выполнено распределение по переделам для затрат: ");
