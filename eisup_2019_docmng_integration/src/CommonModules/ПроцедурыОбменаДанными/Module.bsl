	...
	#Если Клиент Тогда
		...
		Если ОтобразитьВОкнеСообщений Тогда
			...
			Если ЭтоОшибка Тогда
				ttk_ОбщегоНазначения.СообщитьОбОшибке(ИнформацияДляПользователя);
			Иначе
				
				Если ИнформацияДляПользователя <> Символы.ПС Тогда 
					ИнформацияДляПользователя = ttk_ОбщегоНазначения.СформироватьТекстСообщения(ИнформацияДляПользователя);
				КонецЕсли;	
...
Процедура ЗафиксироватьЗавершениеОбмена(СтруктураДанныхНастройкиОбмена, Знач СтрокаСообщенияОбОшибке = "", 
	...
	ИтоговыйКомментарийПриВыгрузкеДанных = ttk_ОбщегоНазначения.СформироватьТекстСообщения(СокрЛП(СтрокаСообщенияОбОшибке));
	...
	Если СтруктураДанныхНастройкиОбмена.Свойство("КомментарийПриЗагрузкеДанных", КомментарийПриЗагрузкеДанных) Тогда
		...
		СтрокаИстории.КомментарийКЗагрузкеДанных = ttk_ОбщегоНазначения.СформироватьТекстСообщения(СокрЛП(КомментарийПриЗагрузкеДанных));
	...
	Если СтруктураДанныхНастройкиОбмена.Свойство("КомментарийПриВыгрузкеДанных", КомментарийПриВыгрузкеДанных) Тогда
		...
		ИтоговыйКомментарийПриВыгрузкеДанных = СокрЛП(ИтоговыйКомментарийПриВыгрузкеДанных + Символы.ПС + ttk_ОбщегоНазначения.СформироватьТекстСообщения(СокрЛП(КомментарийПриВыгрузкеДанных)));
