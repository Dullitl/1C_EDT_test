...
//
Процедура ДобавитьОписаниеОтчета(ТаблицаОписаний, Отчет, Форма) Экспорт
	
	// В этой конфигурации дополнительных форм не предусмотрено
...
//
Функция ДанныеДляЗаполненияДополнительногоОтчета(Отчет, Форма, ПараметрыОтчета) Экспорт
...
Функция ТекстПоляУсловияУСН() Экспорт
...
Функция ИмяУчетнойПолитикиЕСН() Экспорт
