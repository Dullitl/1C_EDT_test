...
Процедура ПриОткрытииДополнительно(ЭтаФорма, НазначаемоеДействие) Экспорт
	...
	ЭтаФорма.ЭлементыФормы.ДействияФормы.Кнопки.Подменю.Кнопки.Перейти.Кнопки.Добавить("СоответствиеПодразделенийИПодразделенийОрганизаций", ТипКнопкиКоманднойПанели.Действие, "Соответствие подразделений и подразделений организаций", НазначаемоеДействие);
