...
Функция ПолучитьПоНастройкеОбменаИнформациюОПравилах(НастройкиОбмена, ЭтоВыгрузкаИзТекущейИБ = Истина) Экспорт
	...
	Попытка
	 ...
	 Исключение
		...
		ttk_ОбщегоНазначения.СообщитьОбОшибке("Ошибка при получении информации о правилах обмена: " + ОписаниеОшибки());
...
Процедура ВыполинтьПоискСоотвестствияПравилВыгрузкиИДанныхПланаОбмена(НастройкиОбмена) Экспорт
	...
	Если Не ЗначениеЗаполнено(НастройкиОбмена.УзелИнформационнойБазы) Тогда
		...
		ttk_ОбщегоНазначения.СообщитьОбОшибке("Не указан узел для обмена данными.");
		Возврат;
    ...
    Исключение
		...
		// в режиме клиента выводим информацию об ошибке
		ttk_ОбщегоНазначения.СообщитьОбОшибке("Ошибка при тестировании соответствия плана обмена и правил выгрузки: " + ОписаниеОшибки());
...
Функция ЗаполнитьНеобходимыеПараметрыНастроекПользователя(ЭтаФорма, ПравилаОбмена, ПравилаОбменаДляПриемника)
	...
	Исключение
		...
		ttk_ОбщегоНазначения.СообщитьОбОшибке("Ошибка при получении информации о настройках правил обмена: " + ОписаниеОшибки());
		Возврат Ложь;
...
Процедура ОбновитьТаблицуНастроекПолейПоиска(ЭтаФорма)
    ...
    Исключение
		...
		// в режиме клиента выводим информацию об ошибке
		ttk_ОбщегоНазначения.СообщитьОбОшибке("Ошибка при получении информации о настройках полей поиска: " + ОписаниеОшибки());
...
Процедура ОбновитьТаблицуНастроекВыгрузкиДанных(ЭтаФорма) 
    ...
    Исключение
		...
		// в режиме клиента выводим информацию об ошибке
		ttk_ОбщегоНазначения.СообщитьОбОшибке("Ошибка при получении информации о настройках выгрузки: " + ОписаниеОшибки());
