...
Функция ЗаполнитьОбъектПоОбъектуXDTO(Прокси, Объект, ОбъектXDTO, Правило,
	...
	Для Каждого Реквизит Из Реквизиты Цикл
		...
		Если ПроверятьПерепроведение Тогда
			Если НайденнаяСтрока.РежимИзмененияДанныхПроведенногоДокумента = РазрешеноСПерепроведением Тогда
				РежимИзменения = РазрешеноСПерепроведением;
			ИначеЕсли НайденнаяСтрока.РежимИзмененияДанныхПроведенногоДокумента = РазрешеноБезПерепроведения
	...
	Для Каждого Реквизит Из Реквизиты Цикл
		...
		Если Не Реквизит.ДопРеквизит Тогда 
			...
			Если НайденнаяСтрока.ВариантПравилаЗаполненияРеквизитов = 
				...
				ИнтеграцияС1СДокументооборотПереопределяемый.ПриЗаполненииСвойстваОбъектаXDTOПоЗначению(Результат,
					Форма,
					Правило.ТипОбъектаДокументооборота,
					РеквизитФормы,
					ТипРеквизита,
