...
Процедура УправлениеФормой(Форма)
	Если Форма.Объект.ЦенаЯвляетсяРегулируемой Тогда 
		...
		Форма.Элементы.ГруппаКодОпределенияЦеныСделки.Доступность = Истина;
		Форма.Элементы.ГруппаМетодЦенообразования.Доступность = Истина;
		Форма.Элементы.ГруппаИсточникиИнформации.Доступность = Истина;
	Иначе
		//Форма.Элементы.ГруппаКодов.Доступность = Ложь;
		Форма.Элементы.ГруппаКодОпределенияЦеныСделки.Доступность = Ложь;
		Форма.Элементы.ГруппаМетодЦенообразования.Доступность = Истина;
