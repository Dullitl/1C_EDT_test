...
Функция ПрочитатьТаблицуКатегорийОбъекта()
	...
	Запрос.УстановитьПараметр("НазначениеКатегорий",     ttk_ОбщегоНазначения.ПолучитьСписокНазначенийСвойствКатегорийОбъектовПоСсылке(ОбъектОтбораКатегорий));
...
Процедура ОткрытьФормуНовойКатегории(ФормаВладелец) Экспорт
	...
	НазначениеКатегорий = ttk_ОбщегоНазначения.ПолучитьСписокНазначенийСвойствКатегорийОбъектовПоСсылке(ОбъектОтбораКатегорий);
