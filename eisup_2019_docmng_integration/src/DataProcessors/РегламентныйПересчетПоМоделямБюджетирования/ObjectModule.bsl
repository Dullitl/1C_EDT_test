	...
	Если НЕ РучнойВыборДокументов Тогда
		...
		Попытка
			...
			Пока Результат.Следующий() Цикл
				...
				Сообщить(ttk_ОбщегоНазначения.ПредставлениеДокументаПриПроведении(ДокументРасчет));
		...
		Исключение
			...
			ttk_ОбщегоНазначения.СообщитьОбОшибке(ОписаниеОшибки(),, ("Не удалось провести документ " + Строка(ДокументРасчет)));
