...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СписокВыбора = Элементы.ПравилаПоискаВидСравнения.СписокВыбора;
...
&НаКлиенте
Процедура ПравилаПоискаВидСравненияПриИзменении(Элемент)
...
Процедура УстановитьЦветаИУсловноеОформление()
	...
	Для Каждого ЭлементСписка Из Элементы.ПравилаПоискаВидСравнения.СписокВыбора Цикл
