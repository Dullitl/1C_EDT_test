...
Процедура КонтрольОстатков(ИмяТабличнойЧасти, СтруктураШапкиДокумента, ОтказПроведения, ЗаголовокСообщения, РежимПроведения) Экспорт
	...
	//Исаенко С.П. 14.09.2018 428
	Если НЕ СтруктураШапкиДокумента.ВидДокумента = "ПеремещениеТоваров" Тогда
	...
	|РегистрНакопления.СвободныеОстатки.Остатки(&ДатаДок,			
	// }}ТТК Сладков А. Заявка № 27.04.2016 окончание
